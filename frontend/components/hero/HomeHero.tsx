...
export default function HomeHero() {
    return(
        <div className="px-45 py-32 max-w mx-auto bg-white">
            <h1 className="leading-[1.1] text-center text-5xl font-extrabold text-[#028174]">Your trusted way</h1>
            <h1 className="leading-[1.1] text-center text-5xl font-extrabold text-[#028174]">to get things <span className="bg-gradient-to-r from-[#028174] to-[#0AB68B] bg-clip-text text-transparent">done in India</span>.</h1>
